...
exports.testUnhideThread = function(test)
{
    //var dateT = new Date();
    var object = require('./threads');
    var Thread = object(0, 'Sboniso', null, 0, 'Question', 'Test9', "This is a Unhiding thread test", new Date(), 'Text');
    ...
    test.equal(Thread.mChildren[0].mStatus, Status.Open, "Could not Unhide the first child of Thread.");
    test.equal(Thread.mChildren[1].mStatus, Status.Open, "Could not Unhide the second child of Thread.");
    test.done();
}
